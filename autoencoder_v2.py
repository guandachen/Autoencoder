# -*- coding: utf-8 -*-
"""
Created on Fri Aug 19 12:35:38 2022
...
for epoch in range(epochs):
    ...
    # sort in an array
    d = new.flatten()
    empty_encoder.append(d[1])
    empty_decoder.append(d[4])
with open('gradient_decoder.pickle', 'wb') as f:
    pickle.dump(empty_decoder, f)
with open('gradient_encoder.pickle', 'wb') as f:
    pickle.dump(empty_encoder, f)
plt.close('all')
plt.figure()
